...
public class Main {
    ...
    public static void main(String[] args) throws FileNotExist {
        ...
        File file = new File("C:\\Users\\Valeria\\Desktop\\IdeaProjects\\HOMETASKEXC\\DATA.txt");
        //readFile(file);
        while (true) {
            try {
                human_info = prompt("Введите через пробел: ФИО, дату рождения (dd.mm.yyyy), номер телефона (семизначный, без плюсов и пробелов) и пол (f или m): ");
